...
export const TRANSLATIONS = {
  tr: {
    ...
    savedBadge: 'Kayıtlı',
    companyLabel: 'Gelen Tırın Firması',
    carrierLabel: 'Gelen Tırın Firması',
    ...
    newCarrierPrompt: 'Eklenecek Firma Adı:',
    listNumberLabel: 'Yüklenecek Malların Liste No',
    listNumberPlaceholder: 'Örn: ML-2026-8942',
    tractorPlateLabel: 'Tır  Plakası',
    ...
    // Shipment Form - Notes
    notesSectionTitle: ' Hasar / Özel Not (Opsiyonel)',
    notesLabel: ' Hasar / Özel Not',
    notesPlaceholder: 'Fark edilen herhangi bir durum veya not yazabilirsiniz...',
    ...
    missingTractorPlate: 'Tır Plakası',
    ...
    historySubtitle: 'Bu cihazda kayıtlı {count} adet kayıt bulunmaktadır',
    historySearchPlaceholder: 'Plaka, firma adı veya liste no ile ara...',
    historyEmptyTitle: 'Henüz Kayıtlı Kayıt Yok',
    ...
    historyNoResults: 'Aramanızla eşleşen kayıt bulunamadı.',
    historyDeleteConfirmTitle: 'Bu kaydı silmek istediğinize emin misiniz?',
    historyDeleteConfirmDesc: 'Bu işlem geri alınamaz. Cihaz hafızasındaki bu kayıt raporu silinecektir.',
    ...
    // Settings View
    settingsTitle: 'Uygulama & Kayıt Ayarları',
    ...
    settingsInspectorTitle: 'Kontrol Eden Personel',
    ...
    settingsEmailDesc: 'Kayıtlar ve fotoğrafların gönderileceği resmi şirket e-posta adresi.',
    recipientEmailLabel: 'Alıcı E-posta Adresi',
    ccEmailLabel: 'Bilgi (CC) E-posta Adresi (Opsiyonel)',

    // Settings Section 4 - Companies
    settingsCompaniesTitle: 'Gelen Tır Firmalarının Listesi',
  ...
  de: {
    ...
    // Shipment Form - Section 1
    unifiedHeader: 'Spedition & Ladedaten',
    sectionCompanyPlate: 'Spedition & Ladedaten',
    targetEmailBar: 'Ziel-E-Mail',
    targetEmailLabel: 'Ziel-E-Mail:',
    savedTargetEmail: 'Gespeichert',
    savedBadge: 'Gespeichert',
    companyLabel: 'Spedition',
    carrierLabel: 'Spedition',
    ...
    listNumberLabel: 'Kommi-Liste Nummer:',
    listNumberPlaceholder: 'z.B.: 2026-8942',
    tractorPlateLabel: 'LKW Kennzeichen',
    tractorPlatePlaceholder: 'z.B.:  HH-XY 123',
    inspectorFieldLabel: 'Prüfendes Personal',
    inspectorLabel: 'Prüfendes Personal',
    quickShiftTip: 'Schicht wechseln',

    // Shipment Form - Section 2 (Photos)
    photoSectionTitle: 'Fotokontrolle (4 Pflichtfotos)',
    sectionPhotosTitle: 'Fotokontrolle (4 Pflichtfotos)',
    ...
    // Shipment Form - Notes
    notesSectionTitle: 'Schadensnotiz (Optional)',
    ...
    listNumberRequired: 'Kommi-Liste Nummer:',
    plateRequired: 'Kennzeichen der Zugmaschine',
    photo1Required: '1. Kennzeichen-Foto der Maschine',
    photo2Required: '2. Foto vorderer Laderaum',
    photo3Required: '3. Foto hinterer Laderaum',
    photo4Required: '4. Foto der Kommi-Liste',
    ...
    missingCompany: 'Spedition',
    missingListNumber: 'Kommi-Liste Nummer:',
    missingTractorPlate: 'Kennzeichen der Maschine',
    ...
    // Settings Section 1 - Personnel (At the top!)
    settingsInspectorTitle: 'Prüfendes Personal',
